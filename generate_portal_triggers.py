...
def generate_drive_triggers(portal_locations, event_name="vehicleEnteredPortal", cooldown=5.0):
    ...
    # Add comment header
    triggers.append("# Auto-generated blocks for portal locations (tile ID 12)")
    triggers.append("# Generated by generate_portal_triggers.py")
    triggers.append("# Copy these into the blocks{} section of your .dat file")
    triggers.append("")
    ...
    for row, col in portal_locations:
        triggers.append(f"# Portal at row {row}, col {col}")
    ...
    # Add wires section
    if wires:
        triggers.append("# Wires connecting triggers to events")
